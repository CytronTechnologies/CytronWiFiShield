...
const char ESP8266_SET_AP_IP[] = "+CIPAP_CUR"; // Set IP address of ESP8266 softAP
...
const char ESP8266_PINWRITE[] = "+CIOWRITE"; // Write GPIO (high/low)
const char ESP8266_PINREAD[] = "+CIOREAD"; // Read GPIO digital value